...
'https://i.postimg.cc/HkNmj7X3/IMG-20260122-WA0005.jpg'
  ...
  'ashrae-buet-inauguration': {
    ...
    overview: "The ASHRAE BUET Student Branch officially commenced its journey toward advancing HVAC&R education, research, and professional excellence through an insightful inauguration ceremony, graced by the distinguished presence of prominent leaders and veterans from the HVAC&R field.",
    date: "October 2024",
    location: "ME Building, BUET",
    category: "Milestone Event",
    attendees: [
        'Faculty members from BUET',
        'Industry leaders in HVAC&R',
...
'https://i.postimg.cc/pr13XttN/DSC05283.jpg',
  ...
  'ashrae-buet-sb-grant-received': {
    ...
    overview: "The ASHRAE BUET Student Branch secured two ASHRAE Undergraduate Program Equipment Grants on its first-ever application, receiving a total of USD 1,370 in funding in recognition of innovative, student-led projects in sustainable cooling systems and heat exchanger design.",
    date: "April 2025",
    location: "ASHRAE Headquarters",
    category: "Achievement",
    attendees: [
        'ASHRAE BUET Student Branch Executive Committee',
        'ASHRAE Officials'
    ],
    gallery: [
    ],
...
'https://i.postimg.cc/wvnbSQX2/20241226-160814.jpg',
  ...
  'ashrae-bangladesh-meeting': {
    ...
    overview: "A ceremony to recognize and celebrate the successful implementation of projects under the ABC (ASHRAE Bangladesh Chapter) post-grant. The event highlighted the innovative projects undertaken by our members and their impact. It was a proud moment for the entire ASHRAE BUET Student Branch.",
    date: "August 2024",
...
'Branch Representation'
  ...
  '1st-panel-farewell': {
    ...
    attendees: [
        ...
        'Current members of ASHRAE BUET SB',
        'Faculty Advisor'
    ],
    gallery: [
